...
public class J2KProcessGroundwater_D extends JAMSComponent {
    ...
    @JAMSVarDescription(access = JAMSVarDescription.AccessType.READ,
    update = JAMSVarDescription.UpdateType.RUN,
    description = "Reach Colmation Factor")
    ...
    private boolean distRG1_RG2() {
        ...
        if (delta_RG2 > 0) {
            ...
            this.run_actRG2 = this.run_maxRG2;//this.run_actRG1 = this.run_maxRG1;
        }
        return true;
    }
    ...
    private boolean calcDarcyGWout() throws JAMSEntity.NoSuchAttributeException {
        ...
        if (this.run_gwTableUpper > this.run_gwTableLower) {
            if (toPoly.getValue() != null) {
                this.calcPotGWOutflow(gwDifference);
        ...
        else if (this.run_gwTableUpper < this.run_gwTableLower) {
    ...
    private boolean updategwTable() throws JAMSEntity.NoSuchAttributeException {
        ...
        this.run_gwTableUpper = run_gwDepthUpper + this.run_baseHeigth;  // + baseHeigth
