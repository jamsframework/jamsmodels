...
@JAMSComponentDescription(
    ...
    public void run() throws JAMSEntity.NoSuchAttributeException {
        ...
        //Hier Berechnung der Wasserspiegellage
        //aus channelStorage, width, length, Geländehöhe
        double run_waterDepth = run_channelStorage/ 1000 / (run_width * run_length);
        double q_m = q_act_tot / (1000 * sec_inTStep);
        run_waterDepth = (((q_m/flow_veloc)  / this.calcHydraulicRadius(flow_veloc, q_m, run_width))- run_width) / 2;
