...
public class J2KProcessGroundwater_D_N_1_newest extends JAMSComponent {
    ...
    public void run() throws JAMSEntity.NoSuchAttributeException {
        ...
        //this.replenishSoilStor();       //Kapillarer Aufstieg (Kann man den auch später machen?)
        ...
        if (entity.getDouble("type") == 3){
            ...
            genRG2.setValue(this.run_genRG2);
            //Grundidee: Errechnen eines potentiellen Ausflusses, der in Abhängigkeit der Gradienten der beteiligten HRUs im RoutingModul
