/*
 * StandardEntityReader_sewer.java
 ...
 * @author S. Kralisch
 */
@JAMSComponentDescription(title = "StandardEntityReader_2",
...
@JAMSVarDescription(access = JAMSVarDescription.AccessType.READ,
    ...
    @JAMSVarDescription(access = JAMSVarDescription.AccessType.READ,
    description = "Name of the attribute describing the reachbis to reach relation in the input file",
    defaultValue = "to_river")
    public Attribute.String reachbis2reachAttribute;    
    ...
    protected void createTopology() throws Attribute.Entity.NoSuchAttributeException {
        ...
        while (reachbisIterator.hasNext()) {
            ...
            toReach = reachMap.get(e.getDouble(reachbis2reachAttribute.getValue()));
            ...
            e.setObject(reachbis2reachAttribute.getValue(), toReach);            
