...
@JAMSComponentDescription(title = "RainCorrection_Richter",
                          author = "Peter Krause",
                          description = "Applies correction according to RICHTER 1985 for measured daily precip sums + wind error by Sevruk")
public class RainCorrectionRichter_Sevruk extends JAMSComponent {
