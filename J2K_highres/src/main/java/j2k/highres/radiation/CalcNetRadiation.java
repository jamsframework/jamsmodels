...
public class CalcNetRadiation extends JAMSComponent {
    ...
    public void run() {
        ...
        //scale the hourly net long wave radiation to highres time step
        netLWRadiation = netLWRadiation * tempRes.getValue() / 60;
