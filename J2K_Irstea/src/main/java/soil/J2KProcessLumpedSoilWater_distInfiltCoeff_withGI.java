...
@JAMSComponentDescription(
        ...
        author="Peter Krause + Mériem Labbas + J Bonneau",
        ...
        version="1.0_0",
        date="2013-04-22")
        public class J2KProcessLumpedSoilWater_distInfiltCoeff_withGI extends JAMSComponent {
    ...
    @JAMSVarDescription(
        ...
        @JAMSVarDescription(
            access = JAMSVarDescription.AccessType.READWRITE,
            description = "water infiltrated by green infrastructure"
            )
            public Attribute.Double infiltrationfromGI;
    ...
    double run_maxMPS, run_maxLPS, run_actMPS, run_actLPS, run_satMPS, run_actDPS, run_satLPS, run_satSoil, run_inRD1, run_inRD2, run_inRain, run_inSnow,
            ...
            run_outRD1, run_outRD2, run_genRD1, run_genRD2, run_infilfromGI;
    ...
    public void run() {
        ...
        this.run_infilfromGI = infiltrationfromGI.getValue();
        ...
        this.run_infiltration = this.run_inRain 
                + this.run_inSnow
                + this.run_snowMelt
                + this.run_actDPS;
        ...
        /** now that impervious runoff has been generated, add infiltration flux from GI: */ 
        this.run_infiltration = this.run_infiltration + this.run_infilfromGI; // here it does not read the volume infiltrated in the one HRU, but from all other. Not sure where the mistake is coming from 
        this.run_infilfromGI = 0;
        ...
        this.run_infiltration = this.calcMPSInflow(this.run_infiltration); //add inflow to MPS and return the rest 
        ...
        infiltrationfromGI.setValue(this.run_infilfromGI);
    }
    ...
    private double calcLPSInflow(double InfiltrationPlusGI){
        this.run_actLPS = this.run_actLPS + InfiltrationPlusGI;
        InfiltrationPlusGI = 0;
