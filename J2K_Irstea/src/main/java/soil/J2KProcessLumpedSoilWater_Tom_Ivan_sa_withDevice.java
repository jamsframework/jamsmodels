...
@JAMSComponentDescription(
        ...
        author="Peter Krause + Francois Tilmant + Thomas Cipriani + Flora Branger",
        ...
        + "Modified to take into account water management devices within the HRUs",
        version="1.0",
        date="2022-10-28")
        public class J2KProcessLumpedSoilWater_Tom_Ivan_sa_withDevice extends JAMSComponent {
 ...
 //           public Attribute.Double soilDistMPSLPS2;
    ...
    @JAMSVarDescription(
            access = JAMSVarDescription.AccessType.READWRITE,
            description = "water infiltrated from Device"
    )
    public Attribute.Double infiltrationfromDevice;
    ...
    double run_maxMPS, run_maxLPS, run_actMPS, run_actMPS2,run_actLPS, run_satMPS, run_actDPS, run_satLPS, run_satSoil, run_inRD1, run_inRD2, run_inRain, run_inSnow,
            ...
            run_outRD1, run_outRD2, run_genRD1, run_genRD2,run_deltaMPS, run_MobileWater,run_actET2,run_reductionFactor,run_deltaETP, run_infilfromDevice; //run_soilDistMPSLPS2
    ...
    public void run() {
        ...
        this.run_infilfromDevice= infiltrationfromDevice.getValue();
        ...
        this.run_infiltration = this.run_inRain + this.run_inSnow +
                this.run_snowMelt + this.run_actDPS;
        this.run_actDPS = 0;
        this.run_inRain = 0;
        this.run_inSnow = 0;
        this.run_snowMelt = 0;
        ...
        run_infiltration2 = this.run_infiltration;
         ...
         /** now that impervious runoff has been generated, add infiltration flux from Device: */ 
        this.run_infiltration = this.run_infiltration + this.run_infilfromDevice; 
        this.run_infilfromDevice = 0;
        ...
        infiltrationfromDevice.setValue(this.run_infilfromDevice);
    }
