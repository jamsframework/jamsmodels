/*
 * J2KProcessReachRouting_bis.java
...
@JAMSComponentDescription(
        ...
        public class J2KProcessReachRouting_bis extends JAMSComponent {
    ...
    @JAMSVarDescription(
            ...
            public Attribute.Double inRD1bis;
    ...
    @JAMSVarDescription(
            ...
            public Attribute.Double inRD2bis;
    ...
    @JAMSVarDescription(
            ...
            public Attribute.Double inRG1bis;
    ...
    @JAMSVarDescription(
            ...
            public Attribute.Double inRG2bis;
    ...
    public void run() {
        ...
        double RD1act = actRD1.getValue() + inRD1bis.getValue();
        double RD2act = actRD2.getValue() + inRD2bis.getValue();
        double RG1act = actRG1.getValue() + inRG1bis.getValue();
        double RG2act = actRG2.getValue() + inRG2bis.getValue();
        ...
        if(DestReach == null && DestReservoir == null){
            ...
            RD1DestIn = DestReach.getDouble("inRD1bis");
            RD2DestIn = DestReach.getDouble("inRD2bis");
            RG1DestIn = DestReach.getDouble("inRG1bis");
            RG2DestIn = DestReach.getDouble("inRG2bis");
        ...
        */
        ...
        //reach
        if(DestReach != null && DestReservoir == null){
            DestReach.setDouble("inRD1bis",RD1DestIn);
            DestReach.setDouble("inRD2bis",RD2DestIn);
            DestReach.setDouble("inRG1bis",RG1DestIn);
            DestReach.setDouble("inRG2bis",RG2DestIn);
