...
/**
 * Konvertierung von DWD-10Minutenwerten ins tabgetrente-Format + Konvertierung
 *
 *
 *
 * @author Manfred Fink TFW
 */
public class DWD_2_J2k1_10min {
    ...
    public void convert(String inputFileName) throws IOException {
        ...
        String paramet = path_file[k - 1].substring(17, 19);
        String startyear = path_file[k - 1].substring(20, 24);
        String st_num = path_file[k - 1].substring(38, 43);
        ...
        String outputFileName = Path + "\\" + paramet + "10_min" + st_num + startyear;

        String outputFilemax = Path + "\\tmax" + st_num + "10_min" + startyear;
        String outputFilemin = Path + "\\tmin" + st_num + "10_min" + startyear;
        String outputFilehum = Path + "\\rhum" + st_num + "10_min" + startyear;
        ...
        double result = 0;
        double result2 = 0;
        startdatestr = linehum.substring(12, 24);
        ...
        int min_int = Integer.parseInt(startdatestr.substring(10, 12));
        // für Stündliche Zeitschritte
        int increment = 600000;
        long itterationen = 0;
        Date date = new Date();
        Date date2 = new Date();
            ...
            while (f <= (j - 1)) {
                ...
                if (f == 0) {
                    ...
                    if (paramet.equals("td") || paramet.equals("tu")) {
                        param1 = Double.parseDouble(hum_string[4]);
                        param2 = Double.parseDouble(hum_string[5]);
                    ...
                    if (f > 1) {
                        ...
                        while (i < itterationen) {
                            ...
                            if (date_tag.getDate() != date_itter.getDate()) {
                                if (jj == 144 || (jj == 108 && paramet.equals("sd"))) {
    ...
    public static void main(String[] args) throws IOException {
        DWD_2_J2k1_10min Precipi = new DWD_2_J2k1_10min();

        //Precipi.convert("D:\\\\cygwin64\\\\home\\\\mfi\\\\DWD\\\\produkt_zehn_min_rr_20100101_20191231_01320.txt");
