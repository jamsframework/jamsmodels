...
@JAMSComponentDescription(
        ...
        author="Manfred Fink",
        description="Calculates Nitrogen transformation Processes in Soil. Method after SWAT2000 with minor adaptions"
        )
   ...
   @JAMSVarDescription(
    ...
    @JAMSVarDescription(
            access = JAMSVarDescription.AccessType.READ,
            update = JAMSVarDescription.UpdateType.RUN,
            description = "Anmount of sediments entering the HRU [kg]"
            )
    ...
    @JAMSVarDescription(
            access = JAMSVarDescription.AccessType.READ,
            update = JAMSVarDescription.UpdateType.RUN,
            description = "Anmount of sediments leaving the HRU [kg]"
            )
    ...
    @JAMSVarDescription(
            access = JAMSVarDescription.AccessType.READ,
            update = JAMSVarDescription.UpdateType.RUN,
            description = "Enrichment factor for sediment bounded N-Pools (Default 1) [-]"
            )
    ...
    @JAMSVarDescription(
            access = JAMSVarDescription.AccessType.READ,
            update = JAMSVarDescription.UpdateType.RUN,
            description = "NH4 in surface runoff added to HRU in kgN"
            )
    ...
    @JAMSVarDescription(
            access = JAMSVarDescription.AccessType.READ,
            update = JAMSVarDescription.UpdateType.RUN,
            description = "Residue-N in surface runoff added to HRU in kgN"
            )
    ...
    @JAMSVarDescription(
            access = JAMSVarDescription.AccessType.READ,
            update = JAMSVarDescription.UpdateType.RUN,
            description = "Activ-N in surface runoff added to HRU in kgN"
            )
    ...
    @JAMSVarDescription(
            access = JAMSVarDescription.AccessType.READ,
            update = JAMSVarDescription.UpdateType.RUN,
            description = "Stable-N in surface runoff added to HRU in kgN"
            )
        ...
        @JAMSVarDescription(
            access = JAMSVarDescription.AccessType.WRITE,
            update = JAMSVarDescription.UpdateType.RUN,
            description = "NH4 in surface runoff leaving the HRU in kgN"
            )
    ...
    @JAMSVarDescription(
            access = JAMSVarDescription.AccessType.WRITE,
            update = JAMSVarDescription.UpdateType.RUN,
            description = "Residue-N in surface runoff leaving the HRU in kgN"
            )
    ...
    @JAMSVarDescription(
            access = JAMSVarDescription.AccessType.WRITE,
            update = JAMSVarDescription.UpdateType.RUN,
            description = "Activ-N in surface runoff leaving the HRU in kgN"
            )
    ...
    @JAMSVarDescription(
            access = JAMSVarDescription.AccessType.WRITE,
            update = JAMSVarDescription.UpdateType.RUN,
            description = "Stable-N in surface runoff leaving the HRU in kgN"
            )
