 ...
 */
public class DWD_2_J2k_d_KL_RSK {
...
//                    date2.setSeconds(0);
                    ...
                    if (paramet.equals("td") || paramet.equals("tu")) {
                        ...
                        param1 = Double.parseDouble(hum_string[3]);
                    } else if (paramet.equals("RSK")){ 
                        param1 = Double.parseDouble(hum_string[6]);
                    }
                        ...
                        while (i < itterationen) {
                            ...
                            if (date_tag.getDate() != date_itter.getDate()) {
                                if (jj == 24 || (jj == 18 && paramet.equals("sd"))) {
                                    ...
                                    if (paramet.equals("rr") || paramet.equals("sd") || paramet.equals("RS") || paramet.equals("RSK")) {
                    ...
                    } else if (paramet.equals("tu") || paramet.equals("rr") || paramet.equals("tu") || paramet.equals("ff") || paramet.equals("RS") || paramet.equals("RSK")) {
                        result = param1;
                        result2 = param2;
                    }
    ...
    public static void main(String[] args) throws IOException {
        DWD_2_J2k_d_KL_RSK Precipi = new DWD_2_J2k_d_KL_RSK();
