...
@JAMSComponentDescription(
    ...
    public class GlacierModule_2_2 extends JAMSComponent {
    ...
    public void run() throws JAMSEntity.NoSuchAttributeException, IOException {
        ...
        if (meltTemp > this.tbase.getValue()) {
            if (this.meltFormula.getValue() == 1) {
                ...
                //complex formula
                //snow melt
                snowMelt = (1 / n) * (this.meltFactorSnow.getValue() + this.alphaSnow.getValue() * this.radiation.getValue()) * (meltTemp - this.tbase.getValue());
                snowMelt = snowMelt * this.area.getValue();
                if (snowMelt >= snowStor) {
                    snowMelt = snowStor;
                    snowStor = 0;
        ...
        double tot_q = q_snow + q_rain + q_ice;
