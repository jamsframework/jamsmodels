...
@JAMSComponentDescription(
    ...
    public class GlacierModule_2_meltCorAsp extends JAMSComponent {
    ...
    public void run() throws JAMSEntity.NoSuchAttributeException, IOException {
        ...
        double MeltCorr = (0.01605 * Math.sin(this.aspect.getValue() - 90) - 0.00025 * this.slope.getValue() + 1 );
        double n = 0;
        ...
        if (meltTemp > this.tbase.getValue()) {
            if (this.meltFormula.getValue() == 1) {
                ...
                snowMelt = snowMelt * MeltCorr * this.area.getValue();
                if (snowMelt >= snowStor) {
                    snowMelt = snowStor;
                    snowStor = 0;
                } else {
