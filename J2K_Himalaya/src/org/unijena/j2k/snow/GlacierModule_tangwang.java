...
@JAMSComponentDescription(
    ...
    public class GlacierModule_tangwang extends JAMSComponent {
    ...
    public void run() throws JAMSEntity.NoSuchAttributeException, IOException {
        ...
        //snow routing
        double T1 = this.glacStorage.getValue();

        double q_snow = (this.snowRunofftm1.getValue() + T1)* Math.exp(-1/this.kSnow.getValue()) + (snowMelt + this.rain.getValue()) * (1-Math.exp(-1/this.kSnow.getValue()));
        ...
        double T2 = allIn - q_snow;

        this.glacStorage.setValue(T2);
        glacOut = tot_q;
