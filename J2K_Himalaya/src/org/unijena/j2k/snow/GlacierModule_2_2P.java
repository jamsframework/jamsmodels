...
@JAMSComponentDescription(
    ...
    public class GlacierModule_2_2P extends JAMSComponent {
    ...
    public void run() throws JAMSEntity.NoSuchAttributeException, IOException {
        ...
        double q_snow = this.snowRunofftm1.getValue() * Math.exp(-1/this.kSnow.getValue()) + (snowMelt) * (1-Math.exp(-1/this.kSnow.getValue()));
        double q_rain = this.snowRunofftm1.getValue() * Math.exp(-1/this.kSnow.getValue()) + (this.rain.getValue()) * (1-Math.exp(-1/this.kSnow.getValue()));
