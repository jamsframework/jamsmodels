...
date = "2013-10-27",
version = "1.0")
public class StandardEntityReaderGI4Sewers_OG extends JAMSComponent {
    ...
    public void init() throws Attribute.Entity.NoSuchAttributeException {
        ...
        //read hru parameter
        hrus.setEntities(J2KFunctions_OG.readParas(FileTools.createAbsoluteFileName(getModel().getWorkspaceDirectory().getPath(), hruFileName.getValue()), getModel()));
        ...
        String fileName = reachFileName.getValue();
        ...
        reaches.setEntities(J2KFunctions_OG.readParas(FileTools.createAbsoluteFileName(getModel().getWorkspaceDirectory().getPath(), reachFileName.getValue()), getModel()));

        
        reachList = J2KFunctions_OG.readParas(fileName, getModel());
        ...
        sewers1.setEntities(J2KFunctions_OG.readParas(FileTools.createAbsoluteFileName(getModel().getWorkspaceDirectory().getPath(), sewer1FileName.getValue()), getModel()));
        ...
        sewers2.setEntities(J2KFunctions_OG.readParas(FileTools.createAbsoluteFileName(getModel().getWorkspaceDirectory().getPath(), sewer2FileName.getValue()), getModel()));
        ...
        sewers3.setEntities(J2KFunctions_OG.readParas(FileTools.createAbsoluteFileName(getModel().getWorkspaceDirectory().getPath(), sewer3FileName.getValue()), getModel()));
        ...
        sewers4.setEntities(J2KFunctions_OG.readParas(FileTools.createAbsoluteFileName(getModel().getWorkspaceDirectory().getPath(), sewer4FileName.getValue()), getModel()));
        ...
        //read GI parameter
        //GI.setEntities(J2KFunctions_OG.readParas(FileTools.createAbsoluteFileName(getModel().getWorkspaceDirectory().getPath(), sewer4FileName.getValue()), getModel()));
    ...
    private void createChildrenMap() {
        ...
        while (reachIterator.hasNext()) {
            ...
            // reach -> reach
            parentNode = (Attribute.Entity) node.getObject(reachToreachAttribute.getValue());
