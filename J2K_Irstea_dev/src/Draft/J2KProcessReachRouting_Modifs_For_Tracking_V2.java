...
@JAMSComponentDescription(
        title = "ReachRouting_KinematicWave_Modify_For_Tracking",
        ...
        description = "Calculates flow processes in the river network by a simplified kinematic wave approach"
                + " and saves temporary actual storage for tracking in ReachTracking module",
        version = "Tracking",
        date = "2021-01-24"
)

public class J2KProcessReachRouting_Modifs_For_Tracking_V2 extends JAMSComponent {
