...
public class J2KProcessReachRouting_Modifs_For_Tracking extends JAMSComponent {
...
// NEW - Saving inRD1, inRD2, inRG1 and inRG2 in new variables to use
        // in ReachTracking component
        
        inRD1Track.setValue(inRD1.getValue());
        inRD2Track.setValue(inRD2.getValue());
        inRG1Track.setValue(inRG1.getValue());
        inRG2Track.setValue(inRG2.getValue());
