...
@JAMSComponentDescription(
        title="ReachManualInflow",
        author="Olivier Grandjouan",
        description="Give a volume input to reaches entities"
        )
        public class ReachManualInflow extends JAMSComponent {
    ...
    @JAMSVarDescription(
            ...
            description = "inflow to the specific reach"
            )
...
/*   @JAMSVarDescription(
    ...
    public void run() {
        ...
        if(entity.getDouble("ID") == reachID.getValue()){
            double inaddIn = this.inaddIn.getValue();
            
            this.inaddIn.setValue(inaddIn + inflow);
