...
public class IrrigationMultipleSourceExtractionGWinReach_NN extends JAMSComponent {
    ...
    @JAMSVarDescription(
            ...
            description = "Current time step RD2 inflow into reach. Will be updated by this component,"+
                    "adding irrigation losses. - input / state variable",
            unit = "L"
    )
    ...
    public Attribute.Double totalIrrigExtractionGWinReach;
    ...
    public Attribute.Double totalIrrigAvailableGWinReach;
    ...
    public void run() {
        ...
        if (!run_currentReach.existsAttribute(irrigationGWinReachEntitiesListName.getValue())) { // no irrigated HRUs --> step out of function
            return;
        }
        ...
        totalIrrigAvailableGWinReach.setValue(run_totalAvailable); // water available for irrigation purpose at this time step
        
        double run_totalDemand = 0;
        double run_providedFraction;

        List<Attribute.Entity> run_l = (List) run_currentReach.getObject(irrigationGWinReachEntitiesListName.getValue());
        ...
        totalIrrigExtractionGWinReach.setValue(run_totalExtraction);
