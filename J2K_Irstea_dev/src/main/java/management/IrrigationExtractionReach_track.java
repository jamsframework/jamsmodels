...
@JAMSComponentDescription(
	...
	+ "irrigation water comes from incoming water to the reach and water inside the reach (actRG1, etc..)."
        ...
        + " Modified after IrrigationExtractionReach_NN version 3.1_0",
        date = "2024-05-31",
        version = "2.1_0"
)
@VersionComments(entries = {
    ...
    @VersionComments.Entry(version = "2.0_0", comment = "Modififed case where no water comes into the reach,"
            ...
            + "from both. All variables contain irrigation terminology"),
    @VersionComments.Entry(version = "2.1_0", comment = "Added allowedMinDischarge -> min remaining discharge after extraction")
})
public class IrrigationExtractionReach_track extends JAMSComponent {
    ...
    public Attribute.Double totalIrrigExtraction;
    ...
    public Attribute.Double totalIrrigAvailable;
...
//    public Attribute.Double trackedVolumeWW;
    ...
    public void run() {
        ...
        double run_allowedExtractionFraction = allowedIrrigExtractionFraction.getValue();
        ...
        double run_actAvailable = run_allowedExtractionFraction * run_totalAct; // water in the reach available for irrigation
