...
author = "Sven Kralisch & Mériem Labbas & Christian Fischer & Olivier Grandjouan",
description = "Component used for the simulation of an overflow device. It takes the different components outflows"
        ...
        + "and save SOD outputs in a supplementary variable",
version = "1.0_0",
date = "2022-03-07")
public class SewerOverflowDevice_track extends JAMSComponent {
    ...
    @JAMSVarDescription(access = JAMSVarDescription.AccessType.READ,
    description = "Target reach's receiving saving attributes")
    ...
    public void run() throws Attribute.Entity.NoSuchAttributeException {
        ...
        if (volumeAll - maxVolume > 0) {
            ...
            for (int i = 0; i < inValues.length; i++) {
                ...
                to_river.setDouble(saveNames[i].getValue(), overflowComp);
