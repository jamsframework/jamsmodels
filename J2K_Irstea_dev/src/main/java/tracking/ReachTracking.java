...
/*
    ...
    @JAMSVarDescription(
            access = JAMSVarDescription.AccessType.READ,
            description = "Tracked RD1 volume from SOD in reach",
            unit = "L"
    )
    ...
    @JAMSVarDescription(
            access = JAMSVarDescription.AccessType.READ,
            description = "Tracked RD2 volume from SOD in reach",
            unit = "L"
    )
    ...
    @JAMSVarDescription(
            access = JAMSVarDescription.AccessType.READ,
            description = "Tracked RG1 volume from SOD in reach",
            unit = "L"
    )
    ...
    @JAMSVarDescription(
            access = JAMSVarDescription.AccessType.READ,
            description = "Tracked RG2 volume from SOD in reach",
            unit = "L"
    )
    ...
    @JAMSVarDescription(
            access = JAMSVarDescription.AccessType.READ,
            description = "Tracked total volume from SOD in reach",
            unit = "L"
    )
...
//            getModel().getRuntime().println("C'est un brin tracé");
            ...
            if(trackedVolumeSodTotal.getValue() != 0){
                
                ArrayTrackedVolumeRD1[t] = ArrayTrackedVolumeRD1[t] - trackedVolumeSodRD1.getValue();
                ArrayTrackedVolumeRD2[t] = ArrayTrackedVolumeRD2[t] - trackedVolumeSodRD2.getValue();
                ArrayTrackedVolumeRG1[t] = ArrayTrackedVolumeRG1[t] - trackedVolumeSodRG1.getValue();
                ArrayTrackedVolumeRG2[t] = ArrayTrackedVolumeRG2[t] - trackedVolumeSodRG2.getValue();
                ArrayTrackedVolumeTotal[t] = ArrayTrackedVolumeTotal[t] - trackedVolumeSodTotal.getValue(); 
                
                ArrayTrackedVolume_actRD1[t] = ArrayTrackedVolume_actRD1[t] - trackedVolumeSodRD1_act.getValue();
                ArrayTrackedVolume_actRD2[t] = ArrayTrackedVolume_actRD2[t] - trackedVolumeSodRD2_act.getValue();
                ArrayTrackedVolume_actRG1[t] = ArrayTrackedVolume_actRG1[t] - trackedVolumeSodRG1_act.getValue();
                ArrayTrackedVolume_actRG2[t] = ArrayTrackedVolume_actRG2[t] - trackedVolumeSodRG2_act.getValue();
                ArrayTrackedVolume_actTotal[t] = ArrayTrackedVolume_actTotal[t] - trackedVolumeSodTotal_act.getValue();  
            }
