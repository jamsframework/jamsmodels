 ...
 * olivier champagne add ice_Runoff to RD1. So ice_Runoff is already considered in the current HRU
 */
...
@JAMSComponentDescription(
    ...
    public class GlacierModuleAlps_RD1 extends JAMSComponent {
...
//            public Attribute.Double alphaSnow;
    ...
    public void run() throws Attribute.Entity.NoSuchAttributeException, IOException {
        ...
        //getModel().getRuntime().println("GlacierModuleAlps_RD1", JAMS.VVERBOSE);
	...
	//getModel().getRuntime().println("SMB in -> netRain: " + this.netRain.getValue(), JAMS.VVERBOSE);
        ...
        if(glacierArea > 0.0){
            ...
            double rd1new = tot_q + this.RD1.getValue();
