...
@JAMSComponentDescription(
        ...
        public class J2KProcessGroundwater_satRG1_capRise extends JAMSComponent {
    ...
    @JAMSVarDescription(
            access = JAMSVarDescription.AccessType.WRITE,
            description = "capilary rise volume",
            unit = "L"
            )
            public Attribute.Double capRiseFlow;
...
//        if (Double.isNaN(run_satRG1)) {
//            getModel().getRuntime().println("satRG1 is NaN. act_RG1 : " + this.run_actRG1 + ". max_RG1 : " + this.run_maxRG1);
//        }
    ...
    public boolean replenishSoilStor(){
        ...
        if(run_actRG2 >= inSoilStor){
            ...
            run_capRiseFlow = inSoilStor;
        }
        else{
            run_capRiseFlow = this.run_actRG2;
            this.run_actSoilStor = this.run_actSoilStor + this.run_actRG2;
            this.run_actRG2 = 0;
        }
        capRiseFlow.setValue(run_capRiseFlow);
