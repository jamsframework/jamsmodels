...
@JAMSComponentDescription(
        ...
        description = "Calculates flow processes in the river network by a simplified kinematic wave approach and we save velocity",
        version = "1.0_1",
        date = "2011-05-30"
)
...
public class J2KProcessReachRouting_Vel extends JAMSComponent {
    ...
    public void run() {
        ...
        waterVelocity.setValue(flow_veloc);
