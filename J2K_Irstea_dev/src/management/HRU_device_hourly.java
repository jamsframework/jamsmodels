...
@JAMSComponentDescription(
        ...
        description = "For any type of water management device located within the HRU "
                ...
                + "works with hourly time step",
        date = "2022-10-27",
        version = "2.0_0")
@VersionComments(entries = {
    @VersionComments.Entry(version = "1.0_0", comment = "Initial version"),
    @VersionComments.Entry(version = "2.0_0", comment = "Hourly time step simulation"
            + "+ Simplification in the code for the initialization")
})
public class HRU_device_hourly extends JAMSComponent {
...
//// Parameters
    ...
    public void run() {
        ...
        if (run_deviceArea == 0) {
            ...
            run_Qinf = Math.min(run_deviceArea * run_Ks * 1000 * 3600, run_actDeviceVol); //run_deviceArea in m2, Ks m/s, Qinf in L during the time step (hour) 
