...
public class IrrigationApplicationSurface_NN extends JAMSComponent {
    ...
    @JAMSVarDescription(
            access = JAMSVarDescription.AccessType.READWRITE,
            description = "HRU net rain, modified by surface irrigation",
            unit = "L"
    )
    ...
    public void run() {
        ...
        if (run_irrigationApplication != 0) {
            netRain.setValue(netRain.getValue() + run_irrigationApplication);
