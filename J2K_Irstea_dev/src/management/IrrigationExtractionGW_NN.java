...
public class IrrigationExtractionGW_NN extends JAMSComponent {
    ...
    public void run() {
        ...
        if (!run_currentHRU.existsAttribute(irrigationEntitiesListName.getValue())) {// no irrigated HRUs --> step out of function
            return;
        }
        ...
        List<Attribute.Entity> run_l = (List) run_currentHRU.getObject(irrigationEntitiesListName.getValue());
