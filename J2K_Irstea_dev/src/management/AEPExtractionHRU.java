...
@JAMSComponentDescription(title = "AEP device to extract water from HRU",
        ...
        + "coming from a sewer reach (threshold totalIn).",
        version = "3.0_0",
        date = "2026-01-20")
public class AEPExtractionHRU extends JAMSComponent {
     ...
     */       
        ...
        public void run() {
                ...
                // Total inflow
                double totalIn = run_inRG1 + run_inRG2;
                ...
                double totalAct = run_actPrel * (run_actRG1 + run_actRG2); // water available for drinking water

                if(totalIn+totalAct > 1E-10) {
